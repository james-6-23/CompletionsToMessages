...
export const api = {
  ...
  updateEndpoint: (id: string, data: { name: string; base_url: string; website_url?: string; logo_url?: string; proxy_url?: string; model_mapping?: Record<string, string> }) => putJson<{ ok: boolean }>(`/api/endpoints/${id}`, data),
